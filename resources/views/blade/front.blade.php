...
@section('main')
    ...
    <div class="container container-fluid-md">
        <div class="row d-flex justify-content-between px-3 px-md-0">
            ...
            <div class="col-12 col-md-3 border rounded p-3 mb-md-0 mb-3">
                <h3 class="mb-3">お気に入り機能・プラン投稿</h3>
                <div class="mb-3">
                    <img src="{{ asset('img/undraw_post_re_mtr4.svg') }}" alt="" width="100%">
                </div>
                <div>自身が行ったプランや、設計したプランをお気に入り登録する、投稿するということができます。</div>
            </div>
            <div class="col-12 col-md-3 border rounded p-3 mb-md-0 mb-3">
    ...
    <div class="container mt-3">
        <div>※プラン投稿・お気に入り機能を使用するには、「<a href="/register">登録</a>」する必要があります。</div>
    </div>
    ...
    <div class="container mb-5 usage">
        <div class="mb-4">
            <h4>プラン設計</h4>
            <div>「<a href="/map">プラン設計</a>」から「始発場所」「終着場所」を入力する。他の「場所1」「場所2」「場所3」「場所4」「場所5」は「集合場所」から「終着場所」までに行きたい場所がある場合に入力する。<br>※初めに入力した住所から半径10km以内の場所を優先的に候補として出力します。<br>※デフォルトでは、車でのルート案内になっています。</div>    
        </div>
        <div class="mb-4">
            <h4>オキニ登録・プラン投稿</h4>
