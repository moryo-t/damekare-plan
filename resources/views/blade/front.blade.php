...
@section('main')
    ...
    <div class="container mb-5 usage">
        <div class="mb-4">
            <h4>プラン設計</h4>
            <div>「<a href="/map">プラン設計</a>」から「始発場所」「終着場所」を入力する。他の「場所1」「場所2」「場所3」「場所4」「場所5」は「始発場所」から「終着場所」までに行きたい場所がある場合に入力する。<br>※初めに入力した住所から半径10km以内の場所を優先的に候補として出力します。<br>※デフォルトでは、車でのルート案内になっています。</div>    
        </div>
        <div class="mb-4">
            <h4>オキニ登録・プラン投稿</h4>
