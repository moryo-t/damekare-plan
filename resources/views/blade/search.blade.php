    ...
    <div>
        <div class="container">
            <div id="form-center" class="d-flex align-items-center justify-content-center"> 
                <form action="/search" method="POST" name="list_form" class="mb-0 w-75">
                    @csrf
                    <div class="input-group">
                        <input type="text" class="form-control" aria-label="Text input with dropdown button" name="result"  id="inputResult" placeholder="都道府県や市区町村、スポットなどを入力">
